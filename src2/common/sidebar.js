            ...
            <Col xs={12}>
              ...
              <div className='sidebar-nav-container'>
                <SidebarNav style={{marginBottom: 0}} ref={(c) => this._nav = c}>
                  ...
                  <SidebarNavItem glyph='icon-fontello-gauge' name='Module' href={::this.getPath('module')} />

                  <div className='sidebar-header'>Normal PAGES</div>
                  <SidebarNavItem glyph='icon-fontello-gauge' name='Default Dashboard' href={::this.getPath('defaultdashboard')} />
                  ...
                  <li className='sidebar-nav-item' style={{display: 'block', height: 45}}>
                    <a href='http://rubix-docs.sketchpixy.com' style={{height: 45}}>
                      ...
                      <span className='name'>Download Progress</span>
                    </a>
                  </li>
                </SidebarNav>
                <br />
        ...
        <div id='avatar'>
          <Grid>
            <Row className='fg-white'>
              ...
              <img src='https://img.veritasprep.com/team/Blin.jpg' width='40' height='40'/>
              </Col>
              <Col xs={8} collapseLeft id='avatar-col'>
                <div style={{top: 23, fontSize: 16, lineHeight: 1, position: 'relative'}}>Blin Kazazi</div>
                <div>
